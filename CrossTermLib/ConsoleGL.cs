...
public class ConsoleGL(int cols, int rows, string fontPath, int fontSize, string title, Vector4 defaultFontColor, Vector4? backgroundColor = null, float paddingPercentage = 1.4f) : IDisposable
{
